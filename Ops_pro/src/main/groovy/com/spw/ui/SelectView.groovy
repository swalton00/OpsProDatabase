...
class SelectView {
    ...
    public void init() {
        ...
        JLabel labelAllCars = new JLabel("This option selects ALL the cars")
        ...
        JLabel labelSpeficCars = new JLabel("Selected cars only")
        carsPanel.add(labelSpeficCars, "left, wrap")
        carsPanel.add(sm.rbType, "left")
        JLabel labelCarsType = new JLabel("By Specific Type")
        carsPanel.add(labelCarsType, "left, wrap")
        ...
        sm.carBox.setSelectedIndex(0)
        carBoxPane.setPreferredSize(new Dimension(150, 90))
        carsPanel.add(carBoxPane)

        JScrollPane typeBoxPane = new JScrollPane(sm.typeBox)
        sm.typeBox.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION)
        sm.typeBox.setLayoutOrientation(JList.VERTICAL)
        sm.typeBox.setVisibleRowCount(10)
        sm.typeBox.setSelectedIndex(0)
        typeBoxPane.setPreferredSize(new Dimension(150, 90))
        carsPanel.add(typeBoxPane)
        ...
        sm.locBox.addListSelectionListener(sc.selectionAction)
        sm.locBox.setSelectedIndex(0)
